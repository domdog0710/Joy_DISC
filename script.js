...
{
  var x = document.getElementById("state" + Questionid + "-" + ID).value;
  
  for(var i = 1; i <= 4; i++)
  {
    if(ID != i)
    {
      if (document.getElementById("state" + Questionid + "-" + i).value == x)
      {
        
        document.getElementById("state" + Questionid + "-" + i).value = "";        
      }
    }           
  }
  ...
  for(var i = 1; i <= 4; i++)
  {
   ...
   document.getElementById("DISC" + i).innerHTML = count;
 }
}

// Test2
function Test2checked()
{
  var count = 0;
  ...
  for(var i = 1; i <= 25; i++)
  {
    for(var j = 1; j <= 4; j++)
    {
      var checkBox = document.getElementById(i + "-" + j);
...
function Test3checked()
{
  ...
  document.getElementById("Test3Horizontal").innerHTML = Horizontalcount;  
  document.getElementById("Test3Vertical").innerHTML = Verticalcount;  
 }
